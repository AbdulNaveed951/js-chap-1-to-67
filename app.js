...
// var first = "Abdul";
//     var last = " Naveed";
//     var answer = 'Abdul Naveed';
//     document.write(firest+"<br>"+last+"<br>"+answer);
...
// question no 1
// var name = "My Name is naveed";
// var age = "And I Am 5 Years Old";
// var class = "I Read In KG_1";
...
// question no 4
// document.write("<br><br>  Question no#04: <br>")
...
// question no 8
// document.write("<br><br>  Question no#08: <br>");
...
// question no 9
// document.write("<br><br>  Question no#09: <br>");
...
// question no 10
// document.write("<br><br>  Question no#10: <br>");
...
// question no 2
// var list=[[0,1,2,3],[1,0,1,2],[2,1,0,1]];
// // Console.log();
...
// Question No 2 
// var str=prompt("my Favourite phone is ");
// var n =str.length;
// document.write(n);
...
// alert(res);
 ...
 // question no 7
// var str = "Welcome city Hyderabad!";
// document.write(" City Hyderabad <br>");
// var res = str.replace("Hyderabad", "Islamabad");
// document.write("After resplacement ");
// document.write( res);

    // question no 8 
// var str = "Ali and sami are best friend They Play Cricket and Football Together";
...
// Question no 10 
/* <h1>Plzz check the output using console</h1>
var str=prompt("Enter your biscuits name");
...
// if(check==true)
// {
//   alert("plz enter a correct user name")
// }
// else{
//   name
// }
...
// var inputCart=prompt("welcome to ABC bakery what do you want ?")
// var isFound=false
...
// if(isFound===false)
// {
// alert("we are sorry." +inputCart+ "is not available")
// } 
...
// if(psd[0]>=0||psd[0]<=9)
// {
//   document.write(" <br> password cannot begin with a number <br> please enter a valid password");
// }
// else
// {
//   if(psd.length<=5)
...
//   if(chck==1)
//   {
//     document.write("<h1>password</h1>"+psd+"password")
...
//  Question no 17 
// var str = prompt("plzz enter your country name");
...
// Question no 1 
// var int=prompt("plzz enter integer value");
// document.write(int)
// document.write(" Number <br>")
// var int=Math.round(prompt("plzz enter integer value "));
// document.write(int)
// document.write(" Round Of Value <br>")
// var int=Math.floor(prompt("plzz enter integer value "));
// document.write(int)
// document.write(" Floor value <br>")
// var int=Math.ceil(prompt("plzz enter integer value "));
// document.write(int)
...
//  Question No 3 
// var a = Math.abs(-4);
// document.write("<h1> The Absolute value Of -4 is </h1>" +a);
// var a = Math.abs(-5);
// document.write("<br> <h1> The Absolute value Of -5 is </h1>" +a);
...
//         tailCount += arr[i];
// }
// document.write("Heads: " + headCount + " <br>" + "Tails: " + tailCount);
...
//     c = a.slice(0,b)
//     alert("The weight is: " + c+  " kilogram")
// }
...
// Question No 8 
//   var y = prompt("plzz enter a secret number"); 
...
//    var str = "Abdul Naveed The Best Programmer is the World";
...
// question no 9   some file have index.html
// function paySalary() {
...
//     document.getElementById("pay").innerHTML = "overtime Pay: " + salary;
// }
//  
...
//     console.log(e);
 ...
 //   question no 1 indexe.html 
  //   question no 2 indexe.html 
  // question no 3 index.html
  // question no 4 index.html
//      question no 5 some code index.html
// var x=0;
...
// {
//   e.preventDefault();
//   document.write(form.fullname.value);
// };
...
// }
 ...
 //  word and pdf file is not open due to some mistake  //
...
//  part 1 (ii)
//   var div=document.getElementById("main-content");
//    var p =(document.childNodes[1].childNodes[2].childNodes[33].childNodes[5]);
//    console.log(p);
...
// part 1(iv)
// function xyz(){
// var first_name=document.getElementById("naveed");
...
// console.log(last_name.firstChild.nodeType);

// part 2(iii)
// var last_name=document.getElementById("last-name");
// var update="last-name:vince";
// last_name.firstChild.nodeValue=update;

// part 2 (iv) 
//  var div=document.getElementById("form-content");
//   var p =(document.childNodes[1].childNodes[2].childNodes[33].childNodes[3].childNodes[1]);
//  console.log(p);
//   part 2 (iv) last child form content
//  var div=document.getElementById("form-content");
//    var p =(document.childNodes[1].childNodes[2].childNodes[33].childNodes[3].childNodes[9]);
//   console.log(p);
...
//             or another method
// part 2(v) 
//  (5) next sibling last name form content
//  var div=document.getElementById("form-content");
//   var p =(document.childNodes[1].childNodes[2].childNodes[27].childNodes[3].childNodes[9]);
//  console.log(p);
// / previous sibling last name form content
//  var div=document.getElementById("form-content");
//   var p =(document.childNodes[1].childNodes[2].childNodes[27].childNodes[3].childNodes[1]);
// //  console.log(p);
// part 2(iv)
